...
export const translations = {
  ...
  zh: {
    ...
    inviteProDesc2: '2. 总共邀请两位以上验证的心理咨询师，即刻开通「来访者预约一对一咨询」功能。',
    seeExample: '查看示例',
    bookingDemoTitle: '来访者预约一对一咨询',
    bookingDemoSubtitle: '开通后，来访者可直接联系您进行线下一对一咨询预约。',
    bookingDemoAvatarLabel: '我的虚拟咨询师',
    bookingDemoContactBtn: '联系咨询师',
    bookingDemoContactTitle: '联系咨询师',
    bookingDemoContactName: '咨询师（实名）',
    bookingDemoContactWechat: '微信号',
    bookingDemoContactEmail: '邮箱',
    bookingDemoContactQual: '专业资质',
    bookingDemoClose: '关闭',
    bookingDemoHint: '来访者点击「联系咨询师」后，可查看您的认证联系方式，完成一对一咨询预约。',
